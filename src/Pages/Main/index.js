              ...
              <div className='noticeBox'>
                ...
                <div className='newsBox'>
                  ...
                  <ul className='moreIndex'>
                    <li className='moreIndexText'>직방 #살아보기 신청하기</li>
                    <li className='moreIndexText'>[고궁뷰]0원집 구경하기</li>
                    <li className='moreIndexText'>뜨는 동네, 번화가에서 별 탈없이 사는 법</li>
                    <li className='moreIndexText'>성수동 원롬, 공짜로 살아본 이야기</li>
                    <li className='moreIndexText'>허위매물 잡는 직방 '허위매물연구소'</li>
                  </ul>
                </div>
                <div className='appBox'>
                  ...
                  <ul className='moreIndex'>
                    <li className='moreIndexText'>[공지] 직방 개인정보처리방침(2020/05/01) 개정</li>
                    <li className='moreIndexText'>[공지] 직방 개인정보처리방침(2020/02/28) 개정</li>
                    <li className='moreIndexText'>[공지] 직방 위치기반서비스 이용약관</li>
                    <li className='moreIndexText'>[공지] 직방 서비스 이용약관(2020/01/13)개정안내</li>
                    <li className='moreIndexText'>[공지] 안심매물관리규정 및 관련 정책 개정 안내</li>
                  </ul>
                </div>
              </div>
            </div>
